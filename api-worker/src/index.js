...
// *** FUNZIONE handleSort AGGIORNATA PER ORDINAMENTO CONCATENATO E VISUALIZZAZIONE ***
function handleSort(event) {
    ...
    // DEBUG: Controlla la console (F12) per vedere se Shift è premuto e lo stato dell'array
    console.log(`Clicked field: ${field}. Shift pressed: ${event.shiftKey}. Current Criteria:`, sortCriteria);
    ...
    document.querySelectorAll('#risultati-tabella th').forEach(th => {
        ...
        th.removeAttribute('data-sort-order'); // Rimuovi l'ordine precedente
    });
    ...
    sortCriteria.forEach((c, i) => {
        ...
        // Imposta l'attributo per il CSS per mostrare l'ordine concatenato
...
// *** FINE FUNZIONE handleSort AGGIORNATA ***
